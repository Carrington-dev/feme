...
def account_verification(request, uidb64, token):
    ...
    context={"form":form, "title":"Confirm your account", "user_id":user_id}
    ...
    return render(request=request, template_name="registration/account_verification.html", context = context)
    ...
    if request.POST:
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                messages.error(request, 'You have not verified your account please check your email')
        else:
...
def form_submitted(request):
    ...
    return render(request,"myauth/form-submitted.html",{"title":title})
